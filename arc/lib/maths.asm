...
.equ PRECISION_BITS, 10
.equ PRECISION_SHIFT, 5
...
;  R1=ptr to vector B.
; Returns:
;  R2=dot product of A and B.
; Trashes: R3-R8
;
; Computes R2 = A . B where:
;
; A = [ a1 ]   B = [ b1 ]
;     [ a2 ]       [ b2 ]
;     [ a3 ]       [ b3 ]
...
dot_product:
    ldmia r0, {r3-r5}                   ; [s10.10]
    ldmia r1, {r6-r8}                   ; [s10.10]
    ...
    mul r2, r3, r6                      ; r2 = a1 * b1  [s20.10]
    mla r2, r4, r7, r2                  ;   += a2 * b2  [s20.10]
    mla r2, r5, r8, r2                  ;   += a3 * b3  [s20.10]
...
; Parameters:
;  R0=ptr to vector A.
;  R1=ptr to unit vector B.
; Returns:
;  R2=dot product of A and B.
; Trashes: R3-R8
;
; Computes R2 = A . B where B is a unit vector.

dot_product_unit:
    ldmia r0, {r3-r5}                   ; [s10.10]
    ldmia r1, {r6-r8}                   ; [s1.10]

    mul r2, r3, r6                      ; r2 = a1 * b1  [s10.20]
    mla r2, r4, r7, r2                  ;   += a2 * b2  [s10.20]
    mla r2, r5, r8, r2                  ;   += a3 * b3  [s10.20]

    mov r2, r2, asr #PRECISION_BITS     ; [s10.10]
    mov pc, lr
